...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20200806153512_DMReferenceInDV")]
    partial class DMReferenceInDV
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.DCAppDataValue", b =>
                {
                    ...
                    b.Property<Guid?>("BaseDataFieldId")
                        .HasColumnType("uniqueidentifier");

                    b.Property<Guid?>("BaseDataModelId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("MultipleReferenceRowIds")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<Guid>("SingleReferenceRowId")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.HasIndex("BaseDataFieldId");

                    b.HasIndex("BaseDataModelId");
            ...
            modelBuilder.Entity("Domain.Entities.DCAppDataValue", b =>
                {
                    b.HasOne("Domain.Entities.DCAppDataField", "BaseDataField")
                        .WithMany()
                        .HasForeignKey("BaseDataFieldId");

                    b.HasOne("Domain.Entities.DCAppDataModel", "BaseDataModel")
                        .WithMany()
                        .HasForeignKey("BaseDataModelId");
            ...
            modelBuilder.Entity("Domain.Entities.Data.DCAppRefEntityDataDefinition", b =>
                {
                    b.HasOne("Domain.Entities.DCAppDataModel", "RefDataModel")
                        .WithMany()
                        .HasForeignKey("RefDataModelId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
